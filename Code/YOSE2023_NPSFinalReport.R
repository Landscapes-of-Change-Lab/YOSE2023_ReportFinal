...
# Read in each dataset from CSV files
pila_list <- read.csv("pila_list.csv")
assoc_list <- read.csv("assoc_list.csv")
veg_list <- read.csv("veg_list.csv")
climatedata <- read.csv("climatedata.csv")
fire_severity <- read.csv("fire_severity.csv")
